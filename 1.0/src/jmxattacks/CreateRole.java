...
public class CreateRole extends Attack{

	String banner = "Please enter options for this module or back to return to the main menu";
	String example = "--role manager";
	String description = "This attack will create a role to assign to users(manager, manager-gui,manager-script,manager-jmx)";
	String name = "CreateRole";
	private String role;
	private ObjectName object ;
	private String mbean = "Users:type=UserDatabase,database=UserDatabase";
	private String operation = "createRole";
